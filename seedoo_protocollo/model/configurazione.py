...
class protocollo_configurazione(orm.Model):
    ...
    _columns = {
        ...
        'genera_segnatura': fields.boolean('Genera Segnatura in PDF Post-Registrazione'),
        'genera_segnatura_allegati': fields.boolean('Genera Segnatura in PDF Allegati'),
        'aggiungi_allegati_post_registrazione': fields.boolean('Aggiungi Allegato Post-Registrazione'),
        'genera_segnatura_allegati_post_registrazione': fields.boolean('Genera Segnatura in PDF Allegati Post-Registrazione'),
        'nuovo_algoritmo_segnatura': fields.boolean('Usa il nuovo algoritmo segnatura'),
        'genera_segnatura_ogni_pagina': fields.boolean('Genera Segnatura su tutte le pagine'),
    ...
    _defaults = {
        ...
        'genera_segnatura_allegati': False,
        'aggiungi_allegati_post_registrazione': False,
        'genera_segnatura_allegati_post_registrazione': False,
        'nuovo_algoritmo_segnatura': False,
        'genera_segnatura_ogni_pagina': False,
