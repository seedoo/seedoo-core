...
class protocollo_aoo(orm.Model):
    ...
    _columns = {
        ...
        'manager_name': fields.char('Nome', size=256),
        'manager_surname': fields.char('Cognome', size=256),
        'manager_tax_code': fields.char('Codice Fiscale', size=256),
        'reserved_employee_id': fields.many2one('hr.employee', 'Responsabile Dati Sensibili'),
        'reserved_name': fields.char('Nome', size=256),
        'reserved_surname': fields.char('Cognome', size=256),
        'reserved_tax_code': fields.char('Codice Fiscale', size=256),
